		...
		<div class="columns is-multiline"> <!-- Columns wrapper tag open -->
						...
						<div class="content">
							...
							<nav class="level">
								...
								<div class="level-right">
									<p class="level-item"><strong>Payment - Cash</strong></p>
								</div>
							</nav>
							...
							<p class="is-bold"> By dash restaurant
								...
								Price-₦770.00
								<br> 
							Contact Customer - 080XXXXXXXX </p>
			...
			<div class="column is-6"> <!-- column tag open-->
				...
				<div class="card">
					...
					<footer class="card-footer is-bold">
						<router-link :to="{ name: 'view-order' }" class="card-footer-item has-text-black" exact> View Detail </router-link>
						<a href="#" class="card-footer-item has-text-black"> Reject </a>
						<a href="#" class="card-footer-item has-text-black"> Confirm </a>
					</footer>
				</div>
