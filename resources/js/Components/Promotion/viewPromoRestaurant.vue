		...
		<div> <!-- Second step tag open -->
			...
			<div class="tabs is-toggle is-fullwidth">
				<ul>
					<li class="" v-bind:class="{ 'active': create }">
						<a @click="[create = true, item=false]">
			...
			<div class="columns" v-if="create"> <!-- Columns wrapper tag open -->
				...
				<div class="column"> <!-- First column tag open-->
					...
					<div class="field">
						<label class="label">item Name <span class="has-text-danger"> * </span>  </label>
				...
				<div class="column"> <!-- Second column tag open-->
					...
					<div class="field">
						<label class="label"> item Description <span class="has-text-danger"> * </span> </label>
						<div class="control has-icons-left has-icons-right">
			...
			<aside class="menu" v-if="item">
				<ul class="menu-list">
					<li><a>1. Salad <span class="delete is-pulled-right" ></span> <span class="fas fa-edit is-pulled-right mr-3 purple-color" @click="[create = true, item=false]"></span> </a></li>
					<li><a>2. Blah    <span class="delete is-pulled-right" ></span> <span class="fas fa-edit is-pulled-right mr-3 purple-color" @click="[create = true, item=false]"></span> </a></li>
					<li><a>3. Soda  <span class="delete is-pulled-right" ></span> <span class="fas fa-edit is-pulled-right mr-3 purple-color" @click="[create = true, item=false]"></span> </a></li>
				</ul>
			</aside>

			<button class="button is-fullwidth" @click="[create = true, item=false]">
